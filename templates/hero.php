...
<section class="hero section light">
	<div class="inner_container section" style="text-align: center;">
		...
		<p style="max-width: 675px; margin-right: auto; margin-left: auto;">Sierra Metals should not return to the short-sighted and self-interested ways of the past. We are making excellent progress in building a company that is positioned for longterm, sustainable growth.</p><p style="max-width: 550px; margin-right: auto; margin-left: auto;">This work is commanding the full attention of the leadership team. At such a crucial time for the Corporation, the proposal by ARC is opportunistic and disruptive.</p>
		<div class="row dark-text top-margin-4em gutter_space_2">
			<div class="col col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="boxed">
					...
					<div class="row gutter_space_1 revert-colour bios">
						<div class="col col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding-bottom: 0;">
			...
			<div class="col col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="boxed">
					...
					<p class="big">
					Annual General and Special Meeting of shareholders to be held online at <a style="font-size: 22px;" href="https://meetnow.global/MFXH4US" target="_blank">meetnow.global</a> on Wednesday, June 28, 2023 at 2:00 p.m. (EDT).
					</p>
				</div>
			</div>
		</div>
